...
const Index = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	<h1 class="svelte-vbdcuh">Great success!</h1>

	<figure class="svelte-vbdcuh">
		<img alt="Borat" src="great-success.png" class="svelte-vbdcuh">
		<figcaption>HIGH FIVE!</figcaption>
	</figure>

	<p class="svelte-vbdcuh"><strong>Try editing this file (src/routes/index.svelte) to test live reloading.</strong></p>`;
});
...
const Nav = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<nav class="svelte-11kwxiv">
		<ul class="svelte-11kwxiv">
			<li class="svelte-11kwxiv"><a class="${escape(null_to_empty(segment === undefined ? "selected" : ""))} svelte-11kwxiv" href=".">home</a></li>
			<li class="svelte-11kwxiv"><a class="${escape(null_to_empty(segment === "about" ? "selected" : ""))} svelte-11kwxiv" href="about">about</a></li>


			<li class="svelte-11kwxiv"><a rel="prefetch" class="${escape(null_to_empty(segment === "blog" ? "selected" : ""))} svelte-11kwxiv" href="blog">blog</a></li>
		</ul>
	</nav>`;
});
...
/* src\node_modules\@sapper\internal\App.svelte generated by Svelte v3.9.1 */
